package kg.kundoluk.school.service.firebase;
...
public class FCMService {
    ...
    public void subscribeTopic(List<String> tokens, String topic) throws ExecutionException, InterruptedException {
        FirebaseMessaging.getInstance().subscribeToTopicAsync(tokens, topic).get();
    }

    public TopicManagementResponse unsubscribeTopic(List<String> tokens, String topic) throws InterruptedException, ExecutionException {
